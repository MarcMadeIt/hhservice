...
async function generateStaticParams() {
    const services = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$client$2f$fetchData$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAllServices"])();
...
async function generateMetadata({ params }) {
    if (!params?.service) {
        return {
            title: "Service ikke fundet",
            description: "Denne service findes ikke."
        };
    }
    const serviceKey = decodeURIComponent(params.service);
    const serviceInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$client$2f$fetchData$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getServiceInfo"])(serviceKey);
    return {
        title: serviceInfo ? `${serviceInfo.name} - Halsnæs Haveservice` : "Service ikke fundet",
        description: serviceInfo ? `Professionel ${serviceInfo.name.toLowerCase()} i Nordsjælland.` : "Service ikke fundet."
    };
}
// **Fix `ServicePage` → Await params korrekt**
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__7f2880._.js.map